// ═══════════════════════════════════════════════════════════════
//  SENTINEL v6.1.0 — STRESS TEST (1000 iterations)
// ═══════════════════════════════════════════════════════════════
...
//   v6.1.0: Added EventPipeline tests
// ═══════════════════════════════════════════════════════════════
...
process.stderr.write('\n🛡️  SENTINEL v6.1.0 — STRESS TEST (' + ITERATIONS + ' iterations)\n\n');
...
for (var i = 0; i < ITERATIONS; i++) {
  try {
    ...
    if (!parsed.version || parsed.version !== 'sentinel-v6.1.0') throw new Error('Wrong version in report: ' + parsed.version);
    ...
    if (!htmlContent.includes('Sentinel v6.1.0')) throw new Error('Version missing in HTML');
