// ═══════════════════════════════════════════════════════════════
//  SENTINEL v5.0.0 — REGRESSION GATE
//  25 rules — each represents a REAL BUG from v3.0 to v4.6.3
//  If any rule fails, deploy is BLOCKED.
// ═══════════════════════════════════════════════════════════════
...
// ─── Run all rules ───
process.stderr.write('\n🛡️  SENTINEL v5.0.0 — REGRESSION GATE\n');
