/**
 * Sentinel v4 — Behavior Correlation Engine (Layer 6)
 * Burst detection, library attribution, entropy calculation, honeypot
 */
...
class CorrelationEngine {
  ...
  _attributeLibraries() {
    ...
    const catSet = new Set(this.events.map(e => e.cat));
  ...
  getReport() {
    return {
      ...
      summary: {
        ...
        diversityScore: this.entropy.diversityScore
      }
    };
  }
}
