// ═══════════════════════════════════════════════════════════════
//  SENTINEL v6.0.0 — SIGNATURE DATABASE
// ═══════════════════════════════════════════════════════════════
// CHANGE LOG v6.0.0 (2026-02-25):
//   FROM v5.0.0:
//   - KEPT: ALL C-SIG-01 through C-SIG-06 contracts
//   - KEPT: 7 library signatures + exfil patterns
//
// LAST HISTORY LOG:
//   v5.0.0: 7 signatures + exfil patterns (121 lines)
