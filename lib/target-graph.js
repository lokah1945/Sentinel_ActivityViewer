// ═══════════════════════════════════════════════════════════════
//  SENTINEL v6.0.0 — TARGET GRAPH
// ═══════════════════════════════════════════════════════════════
// CHANGE LOG v6.0.0 (2026-02-25):
//   FROM v5.0.0:
//   - KEPT: ALL C-TG-01 through C-TG-08 contracts intact
//   - KEPT: Recursive auto-attach, Worker Pipeline, Per-target Inventory
//   - KEPT: Smart triage for about:blank
//
// LAST HISTORY LOG:
//   v5.0.0: Recursive auto-attach + Worker Pipeline (256 lines)
