// ═══════════════════════════════════════════════════════════════
//  SENTINEL v6.1.0 — ANTI-DETECTION SHIELD + QUIET MODE
// ═══════════════════════════════════════════════════════════════
// CHANGE LOG v6.1.0 (2026-02-25):
//   FROM v6.0.0:
//   - CHANGED: Stack trace filter 'patchright' → 'playwright-extra'
...
//   v6.0.0: Added playwright-extra to stack filter
//
