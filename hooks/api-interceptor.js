...
function getInterceptorScript(config = {}) {
  ...
  (function() {
    ...
    log('system', 'BOOT_OK', {
      ...
      isTop: window === window.top, timestamp: Date.now(), version: 'v4.2.0', categories: 37
    ...
    if (typeof window.__SENTINEL_PUSH__ === 'function') {
      setInterval(function() {
        if (_sentinel.events.length > 0) {
          try {
            var batch = _sentinel.events.slice(0, 500);
            _sentinel.events = _sentinel.events.slice(500);
