/**
 * Sentinel v4.4 — Forensic Report Generator (Layer 7)
...
function generateHtml(report, correlation) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
    '<title>Sentinel v4.4 — Forensic Maling Catcher Report</title><style>' +
    ...
    '<h1>Sentinel v4.4 — Forensic Maling Catcher Report</h1>' +
    ...
    '<footer>Sentinel v4.4 — Zero Escape Architecture — 37 Categories — Generated ' + new Date().toISOString() + '</footer>' +
    '</div>' +
