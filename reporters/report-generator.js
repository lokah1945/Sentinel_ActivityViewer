...
function generateHtml(report) {
  ...
  return '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">\n<title>Sentinel v4.2 — Forensic Maling Catcher Report</title>\n<style>\n' +
    ...
    '<div class="card"><h3>Threats</h3><div class="value ' + (threats.length > 5 ? 'danger' : threats.length > 0 ? 'warning' : 'safe') + '">' + threats.length + '</div></div>\n' +
    ...
    // Threats
    (threats.length > 0 ?
      '<div class="section">\n<h2>🚨 Threat Assessment (' + threats.length + ')</h2>\n' +
